...
GEN_ERROR_PROMPT = "'Error(s) occurred during the execution of test suite for the `simplejson` project! Please correct the test suite accordingly!'"
...
EVAL_PROMPT = "'Evaluate the given test suite for the `simplejson` project based on the latest execution reports!'"
